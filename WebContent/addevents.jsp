...
<!--[if IE]>
        ...
        <![endif]-->
<title>Virulent Accounts Detection in Social Network based Promotions</title>
...
<body style="background-color:powderblue;">
	...
	<!-- MENU SECTION END-->
	<div id="slideshow-sec" style="background-image: url('images/bg.jpeg');">
						...
						<form name="regform" action="AddEventServlet" method="post">
							...
							<div class="form-group">
								<label>Company</label> <input class="form-control"
									name="company" type="text" style="width: 50%;" />
							</div>
							<div class="form-group">
							...
							<button type="submit" class="btn btn-success btn-lg"
								onclick="return validate()">Add Event</button>
